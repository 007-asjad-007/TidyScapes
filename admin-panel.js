...
const firebaseConfig = {
    ...
    try {
      ...
      querySnapshot.forEach((doc) => {
        ...
        blogCard.innerHTML = `
          ...
          <img src="${blog.imageURL || "default-image.jpg"}" alt="${blog.title}" style="width: 100px; height: auto;" />
  ...
  editBlogForm.addEventListener("submit", async (e) => {
    ...
    const updatedData = {
      ...
      date: firebase.firestore.Timestamp.fromDate(new Date(document.getElementById("editDate").value)),
    };
